...
# orginal (python 2 version) author is Kiran Bandla.
...
class pygoogle:
    ...
    def __search__(self,print_results=False):
        ...
        for page in range(0,self.pages):
            ...
            data = json.loads(str(search_results.read(), "utf-8"))
    ...
    def search_page_wise(self):
        ...
        for page in range(0,self.pages):
            ...
            data = json.loads(str(search_results.read()))
            urls = []
